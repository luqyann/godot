...
extern class SpringArm extends godot.Spatial {
	...
	**/
	...
	/**		
		The layers against which the collision check shall be done. See [$DOCS_URL/tutorials/physics/physics_introduction.html#collision-layers-and-masks](Collision layers and masks) in the documentation for more information.
	**/
