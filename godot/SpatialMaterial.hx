...
extern class SpatialMaterial extends godot.Material {
	/**		
		...
		`godot.SpatialMaterial_AsyncModeEnum.visible` is the default and the best for most cases.
	**/
	@:native("AsyncMode")
	public var asyncMode:godot.SpatialMaterial_AsyncModeEnum;
	...
	**/
	...
	/**		
		If `true`, enables the specified flag. Flags are optional behavior that can be turned on and off. Only one flag can be enabled at a time with this function, the flag enumerators cannot be bit-masked together to enable or disable multiple flags at once. Flags can also be enabled by setting the corresponding member to `true`. See `godot.SpatialMaterial_Flags` enumerator for options.
	**/
	@:native("SetFlag")
	...
	**/
	...
	@:native("SetAsyncMode")
	public function setAsyncMode(mode:godot.SpatialMaterial_AsyncModeEnum):Void;

	@:native("GetAsyncMode")
	public function getAsyncMode():godot.SpatialMaterial_AsyncModeEnum;
}
