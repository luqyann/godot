...
extern class Navigation2DServer {
	/**
		`map_changed` signal.
	...
	**/
	public static extern inline function mapGetPath(map:godot.RID, origin:godot.Vector2, destination:godot.Vector2, optimize:Bool, ?navigationLayers:UInt):std.Array<godot.Vector2> {
	...
	/**		
		Returns the navigation path to reach the destination from the origin. `navigation_layers` is a bitmask of all region layers that are allowed to be in the path.
	**/
	public static overload extern inline function mapGetPath(map:godot.RID, origin:godot.Vector2, destination:godot.Vector2, optimize:Bool):std.Array<godot.Vector2> {
	...
	/**		
		Returns the navigation path to reach the destination from the origin. `navigation_layers` is a bitmask of all region layers that are allowed to be in the path.
	**/
	public static overload extern inline function mapGetPath(map:godot.RID, origin:godot.Vector2, destination:godot.Vector2, optimize:Bool, navigationLayers:UInt):std.Array<godot.Vector2> {
		return cs.Lib.array(cs.Syntax.code("MapGetPath({0}, {1}, {2}, {3}, {4})", map, origin, destination, optimize, navigationLayers));
	}
	#end
	...
	**/
	...
	public static function mapGetClosestPoint(map:godot.RID, toPoint:godot.Vector2):godot.Vector2;

	/**		
		Returns the owner region RID for the point returned by `godot.Navigation2DServer.mapGetClosestPoint`.
	**/
	@:native("MapGetClosestPointOwner")
	public static function mapGetClosestPointOwner(map:godot.RID, toPoint:godot.Vector2):godot.RID;
	...
	**/
	...
	public static function regionOwnsPoint(region:godot.RID, point:godot.Vector2):Bool;
	...
	**/
	...
	public static function regionSetTransform(region:godot.RID, transform:godot.Transform2D):Void;

	/**		
		Sets the navigation mesh for the region.
	**/
	@:native("RegionSetNavpoly")
	public static function regionSetNavpoly(region:godot.RID, navPoly:godot.NavigationPolygon):Void;
	...
	**/
	...
	/**		
		Returns the starting point of a connection door. `connection` is an index between 0 and the return value of `godot.Navigation2DServer.regionGetConnectionsCount`.
	**/
	@:native("RegionGetConnectionPathwayStart")
	public static function regionGetConnectionPathwayStart(region:godot.RID, connection:Int):godot.Vector2;

	/**		
		Returns the ending point of a connection door. `connection` is an index between 0 and the return value of `godot.Navigation2DServer.regionGetConnectionsCount`.
	**/
	@:native("RegionGetConnectionPathwayEnd")
	public static function regionGetConnectionPathwayEnd(region:godot.RID, connection:Int):godot.Vector2;
	...
	**/
	...
	public static function agentSetVelocity(agent:godot.RID, velocity:godot.Vector2):Void;

	/**		
		Sets the new target velocity.
	**/
	@:native("AgentSetTargetVelocity")
	public static function agentSetTargetVelocity(agent:godot.RID, targetVelocity:godot.Vector2):Void;

	/**		
		Sets the position of the agent in world space.
	**/
	@:native("AgentSetPosition")
	public static function agentSetPosition(agent:godot.RID, position:godot.Vector2):Void;
	...
	**/
	...
	/**		
		...
		Note: Created callbacks are always processed independently of the SceneTree state as long as the agent is on a navigation map and not freed. To disable the dispatch of a callback from an agent use `godot.Navigation2DServer.agentSetCallback` again with a `null` object as the `receiver`.
	**/
